...
use Talos\Restaurant\Model\ResourceModel\MenuAppetizer as ResourceModel;
use Talos\Restaurant\Model\ResourceModel\MenuAppetizer\Collection;

class MenuAppetizer extends AbstractExtensibleModel
{
    /**
     * MenuAppetizer constructor.
    ...
    {
        return ['id', 'menu_id', 'appetizer_id'];
    }
}